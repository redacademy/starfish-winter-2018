									...
									foreach($carousel_cells as $carousel_cell){
										...
										//wrap in carousel cell with all the content and img
											echo '<div class="carousel-cell-images' . ($single_img ? '' : ' carousel-double') . '">'; //if there is no secondary img -> add nothing, otherwise -> add class carousel-double
												echo '<img src="' . $carousel_cell['about_carousel_cell_image_primary'] . '" class="carousel-cell-image-primary" alt="" />';
												if ($single_img == false) { //if there is secondary img -> show the secondary img on screen
													echo '<img src="' . $carousel_cell['about_carousel_cell_image_secondary'] . '" class="carousel-cell-image-secondary" alt="" />';
												}
											echo '</div>';
					...
					<section class="about-box-area">
						...
						<div class="content-box">
							...
							<div class="content-box-content">
								<a class="btn-transparent" href="<?php echo esc_url(get_permalink(get_page_by_path( 'team' ) ) ); ?>">Meet the team
